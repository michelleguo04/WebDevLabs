...
function greetingFunc() {
  ...
  } else if (h >= 18 && h < 22) {  // Extending the "Good evening" range
  ...
  console.log(greeting);  // Ensures it's displayed in the console

  // Update the webpage if the <h2> exists
...
// Ensure greetingFunc only runs on index.html
